...
export default function ExperienceStructuredData({ experience }: ExperienceStructuredDataProps) {
  ...
  const structuredData = {
    ...
    ...(experience.period.includes("Present") ? {} : { endDate: experience.period.split(" - ")[1] }),
    employer: {
      "@type": "Organization",
